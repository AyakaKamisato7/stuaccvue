        ...
        <el-container>
            ...
            <el-main>
                <div v-if="currentStep == 0">
                    ...
                    <el-table :data="tableData.complaintList" style="width: 100%">
                        <el-table-column prop="Floor" label="Floor" width="150px" />
                        <el-table-column prop="RoomNum" label="RoomNum" width="150px" />
                        <el-table-column prop="IncidentDate" label="IncidentDate" width="200px" />
                        <el-table-column prop="IncidentTime" label="IncidentTime" width="200px" />
                        ...
                        <el-table-column label="Operation">
                            ...
                            <template #default="scope">
                                ...
                                <el-button link type="primary" size="small"
                                    @click="delComplaint(scope.row); open1()">Delete</el-button>
                            </template>
                        </el-table-column> 
                    </el-table>
                    <!-- dialog -->
                ...
                <el-watermark :font="font" class="watermark-fullscreen" content="Let's solve that!"
                    ...
                    <div v-if="currentStep == 1" class="page1">
                        <h2 style="color: black;">Anything that makes you uncomfortable? Tell us!</h2>
                        <br>
                        <br>
                        <br>
                        <br>
                        <br>
                        <br>
                        <div class="app-container" style="margin-left: 35%; margin-bottom: 15%;">
                            <el-row :gutter="20">
                                <el-col :span="4" style="margin-right: 7%;">
                                    <el-card class="guide-link-card" :body-style="{ padding: '32px' }"
                                        style="background-color: rgb(2,113,114); width: 195px; height: 195px; color: azure;"
                                        @click="goMyComplaint(); getTableData();">
                                        <div class="card-content">
                                            <i class="yourFirstIconClass"></i>
                                            <div class="card-title">Complaints submitted</div>
                                        </div>
                                    </el-card>
                                </el-col>
                                <el-col :span="4">
                                    <el-card class="guide-link-card" :body-style="{ padding: '32px' }"
                                        ...
                                        <div v-loading.fullscreen.lock="loading" class="card-content">
                                            ...
                                            <div class="card-title">A new Complaint</div>
                                        </div>
                                    </el-card>
                                </el-col>
                            </el-row>
                    ...
                    <div v-if="currentStep == 2">
                        <div style="display: flex; align-items: center; justify-content: flex-start;">
                            <h2 style="margin-right: 136px;margin-left: 45%; font-size: 30px;">Complaint</h2>
                            <el-button color="#626aef" :dark="isDark" plain @click="refresh">Back</el-button>
                        </div>
                        <el-form :model="form" label-width="100px">
                            <el-form-item label="Name" style="margin-left: 27%;">
                                <el-input style="width:50%;" v-model="form.Name" disabled :value="form.Name" />
                            </el-form-item>
                            <div style="display: flex; justify-content: space-around;">
                                <el-form-item label="Floor" style="margin-left: 27%; flex-grow: 1;">
                                    <el-select v-model="form.Floor" placeholder="please select the floor">
                                ...
                                <el-form-item label="Room num" style="flex-grow: 1; margin-left: -33.5%;">
                                    <el-select v-model="form.RoomNum" placeholder="please select the room">
                            ...
                            <el-form-item label="Time of occurrence" style="margin-left: 27%;">
                                <el-col :span="11">
                                    <el-date-picker v-model="form.IncidentDate" type="date"
                                        placeholder="Select incident date" style="width: 108.7%; margin-bottom: 3%;" />
                                </el-col>
                                <el-col :span="2" class="text-center" style="margin-left: 27%;">
                                    <span class="text-gray-500">-</span>
                                </el-col>
                                <el-col :span="11">
                                    <el-time-picker v-model="form.IncidentTime" placeholder="Select incident time"
                                        style="width: 108.7%" />
                                </el-col>
                            </el-form-item>
