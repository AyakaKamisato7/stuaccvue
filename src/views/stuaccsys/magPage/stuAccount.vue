...
export default {
    ...
    setup() {
        ...
        function searchStu(){
            axios.post('http://localhost:8080/findStu',{
        ...
        function fetchData() {
            axios.post('http://localhost:8080/getAllStuAccount').then((result) => {
                filterTableData.stuList = result.data
            }).catch((err) => {
                console.log(err)
            });
        ...
        function handleDelete(row) {
            axios.post('http://localhost:8080/delStuAccount', {
                userId: row.userId
            }).then((result) => {
                console.log(result);
                fetchData();
        ...
        function updateInfo() {
            axios.post('http://localhost:8080/updateStu', form).then((result) => {
                console.log(result);
                fetchData();
